...
namespace Reflect.GameServer.ServerCore
{
    ...
    public class FileCache
    {
        ...
        private readonly SortedDictionary<DateTime, string> _entriesByTimestamp =
            new SortedDictionary<DateTime, string>();

        private readonly object _lock = new object();

        private readonly SortedDictionary<string, FileCacheEntry> _pathsByKey =
            new SortedDictionary<string, FileCacheEntry>();

        private readonly SortedDictionary<DateTime, string>
            _pathsByTimestamp = new SortedDictionary<DateTime, string>();
        ...
        public bool InsertPath(string path, string prefix = "/", TimeSpan timeout = new TimeSpan(),
        ...
        private struct FileCacheEntry
        {
            ...
            public FileCacheEntry(string pfx, InsertHandler h, DateTime ts = new DateTime(),
